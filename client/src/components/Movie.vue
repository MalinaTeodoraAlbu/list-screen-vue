      ...
      <div class="separator"></div>
        <div class="movie-rating">
          ...
          <div class="star-rating">
            <span v-for="index in 10" :key="index" class="star" :class="{ 'filled': index <= Math.floor(movie.Rating), 
            'half-filled': index > Math.floor(movie.Rating) && index - 0.5 <= movie.Rating }">&#9733;</span>
...
export default {
  ...
  .movie {
    ...
    color: white;
    border-radius: 8px;
    box-shadow: rgba(254, 254, 254, 0.2) 0px 2px 2px 1px, rgba(59, 59, 59, 0.4) 0px 4px 6px -1px, rgba(59, 59, 59, 0.4) 0px 1px 0px inset;
    overflow: hidden;
