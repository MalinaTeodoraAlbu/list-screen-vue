  ...
  <div>
    <nav class="nav" >
      ...
      <ul class="nav-links">
        ...
        <li>
          <router-link class="link" :to="{ name: 'MyList' }"><span :class="{ 'colored-link': $route.name === 'MyList' }">My list</span></router-link>
        </li>
        <li><router-link class="link" to="/movies"><span :class="{ 'colored-link': $route.path === '/movies' }">All Movies</span></router-link></li>
        <li><router-link class="link" to="/new-movies"><span :class="{ 'colored-link': $route.path === '/new-movies' }">New Movies</span></router-link></li>
        <li><router-link class="link" to="/top-movies"><span :class="{ 'colored-link': $route.path === '/top-movies' }">Top Movies</span></router-link></li>
        <li>
